"""portfolio.py — V4: Buy cheap YES tokens.

Entry: YES 0.06–0.10 (same markets as V1, opposite side)
Take profit: YES >= TAKE_PROFIT_YES (0.15) = NO drops to 0.85 (V1's old stop level)
Stop loss: YES drops STOP_LOSS_PCT (50%) from entry price
...
class AutoPortfolio:
    ...
    def can_open_position(self):
        return (len(self.positions) < MAX_POSITIONS and
                self.capital_disponible >= 0.50)  # YES positions can be very cheap
